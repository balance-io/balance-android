...
import io.balance.features.main.MainMvpView
import io.balance.features.main.MainPresenter
...
class MainPresenterTest {
    ...
    fun getPokemonReturnsPokemonNames() {
        ...
        verify(mockMainMvpView).showBalances(pokemonList)
    ...
    fun getPokemonReturnsError() {
        ...
        verify(mockMainMvpView, never()).showBalances(any())
    }
}